...
- Frontend includes a timeline-first UI for tracks, keyframes, scrubber, and
  live preview.
...
1. Finish the first usable editor workflow for importing and timing logo
   animation sequences.
2. Improve timeline affordances (selection/editing, keyframe ergonomics,
   playback control polish).
...
- Signoff on cycle packet #1 from the UI/UX run should be captured and merged
  before shipping.
