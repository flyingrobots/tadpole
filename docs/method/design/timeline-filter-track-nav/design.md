...
- Date: 2026-05-31
- Scope: Timeline UX refinement for faster large-track browsing and keyframe traversal.
...
3. Expose quick access actions and discoverability in the top toolbar and shortcut panel.
...
- Keyframe stepping (`","` and `"."`) jumps around keyframes in the currently selected track and syncs selection to the destination keyframe.
